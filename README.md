...
<body>
    <div style="max-width: 800px; margin: 40px auto; padding: 20px; background-color: #f9f9f9; border: 1px solid #ddd; box-shadow: 0 0 10px rgba(0, 0, 0, 0.1);">
        <div style="text-align: center; margin-bottom: 20px;">
            ...
            <img src="https://komarev.com/ghpvc/?username=arhyel24&label=PROFILE+VIEWS&color=blueviolet&style=flat&abbreviated=true" alt="Arhyel24" style="width: 150px; border-radius: 50%; margin: 20px;" />
        ...
        <div style="display: flex; flex-direction: row; justify-content: center; margin-bottom: 20px;">
            <img align="center" src="https://github-readme-streak-stats.herokuapp.com/?user=arhyel24&" alt="Wyteshadow" style="width: 100%;  margin: 10px;" />
        </div>
        ...
        <div style="margin-bottom: 20px;">
            ...
            <p align="left" style="margin-bottom: 20px; width: 100%;"> <a style="width: 100%;" href="https://github.com/ryo-ma/github-profile-trophy"><img src="https://github-profile-trophy.vercel.app/?username=arhyel24&column=4&row=2&no-bg=true&no-frame=true&theme=darkhub" alt="wyteshadow" /></a> </p>
        </div>
        <div style="margin-bottom: 20px;">
